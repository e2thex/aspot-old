...
(*** START DATABASE DEF ***)
(*
type database = Database of string * obj_class list
and obj_class = Class    of string * field list
and field     = Field    of string * field_type
and field_type = 
            | Intield 
            | BoolField 
            | StringField of int
            | RefField of obj_class
            | RefListField of obj_class
*)
